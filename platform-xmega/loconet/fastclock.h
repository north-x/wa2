#ifndef FASTCLOCK_INCLUDED
#define FASTCLOCK_INCLUDED
...
*****************************************************************************
 ...
 Title :   LocoNet Fast Clock header file
...
void notifyFastClock( byte Rate, byte Day, byte Hour, byte Minute, byte Sync ) ;
void notifyFastClockFracMins( word FracMins ) ;
