...
do { \
  VoidFnct instr = (VoidFnct) pgm_read_word(&instruction_table[(opcode)]); \
  instr(); \
...
#if 0
#define READ(a) a>255?p_progmem[a&0xFF]:mem[a]
#define WRITE(a,b) mem[a] = b

#define READ_ZP(a) mem[a]
#define READ_STACK(a) mem[a]

#define WRITE_ZP(a,b) mem[a] = b
#define WRITE_STACK(a,b) mem[a] = b

#define READ_CODE(a) a>255?p_progmem[a&0xFF]:mem[a]
#else

#define READ(a) mcpu_read_mem(a)
#define WRITE(a,b) mcpu_write_mem(a,b)

#define READ_ZP(a) mcpu_read_mem(a)
#define READ_STACK(a) mcpu_read_mem(a)

#define WRITE_ZP(a,b) mcpu_write_mem(a,b)
#define WRITE_STACK(a,b) mcpu_write_mem(a,b)

#define READ_CODE(a) mcpu_read_mem(a)
...
extern unsigned char cycle_clock;
extern unsigned char mem[];
extern unsigned char *p_progmem;
